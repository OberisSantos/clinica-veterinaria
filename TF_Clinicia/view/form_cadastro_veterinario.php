    ...
    <div class="container-fluid text-center">  
        ...
        <div class="row content"> 
            ...
            <div class="container col-sm-8 text-left"> 
                ...
                <form action="../models/inserir_veterinario_model.php" method="post" class="modal fade" id="idveterinario">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <input id="codigo" name="codigo" placeholder="Matricula do Veterinário" class="form-control input-md" required="" type="text" maxlength="20" >
