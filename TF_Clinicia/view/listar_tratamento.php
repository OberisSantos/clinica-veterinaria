        ...
        <div class="row content"> 
            ...
            <div class="container col-sm-8 text-left"> 
                <?php
                    ...
                    include_once "../models/tratamento_model.php";
                    ...
                    if (isset($_POST['input_pesquisa']) AND isset( $_POST['radio_pesquisa'])){
                        ...
                        $resultado_busca = $tratamento_model ->listar_tratamento($conn);
                    }
                    ...
                    if ($resultado_busca ->num_rows > 0) {
                        ...
                        echo"
                            <div class='table-responsive'>
                                ...
                                <caption><b>Lista de Tratamento</b></caption>
                                <br>
