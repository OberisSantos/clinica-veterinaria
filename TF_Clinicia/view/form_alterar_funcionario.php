    ...
    <div class="container-fluid text-center">  
        ...
        <div class="row content"> 
            ...
            <div class="container col-sm-8 text-left"> 
                ...
                <!--Formulário de alterar de Funcionario--> 
                <form action="../models/alterar_funcionario_model.php" method="post" class="modal fade" id="idcliente">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content"><!--define conteudo da janela-->
                            ...
                            <div class="modal-header">                                
                                ...
                                <h4 class="modal-title">Alterar dados do Funcionário</h4>
                            </div>
